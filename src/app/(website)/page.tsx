  ...
  const plans = [
    {
      ...
      features:[
        ...
        ' Automate comment repliece to enhance audience interaction',
        'Turn followers into customers with targetted messaging'
      ],
      cta:'Get Started'
    },
    {
  ...
  return (
    <main>
      <section className="relative bg-gradient-to-b from-slate-900 via-blue-900 to-bg">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#0f172a_1px,transparent_1px),linear-gradient(to_bottom,#0f172a_1px,transparent_1px)] bg-[size:4rem_4rem] mask-image-[radial-gradient(ellipse_60%_50%_at_0%,#000_70%,transparent_110%)]" />
        ...
        <div className="relative">
          <div className="container px-4 py-8">
            <div className="flex items-center justify-between">
              ...
              <Button className="bg-blue text-primary text-blue-800">
            ...
            <div className='mx-auto mt-16 max-w-3xl text-center'>
              ...
              <div className='mt-8 flex justify-center gap-4'>
                ...
                size='lg'
                variant='outline'
                className='bg-blue-600 text-white hover:bg-blue-900/50'
                >
                  Get Started
                </Button>
      ...
      <section className='container w-full py-12 md:py-24 lg:py-36 bg-background'>
